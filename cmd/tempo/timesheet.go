...
const (
	...
	SupportTime       = "How much time did you supporting a software system (in hours): "
...
func requestTimeInput() (devTime, ptoTime, supportTime, meetingTime int) {
	...
	supportTime = getTime(SupportTime)
	meetingTime = getTime(MeetingTime)

	totalHoursThisWeek := meetingTime + ptoTime + supportTime + devTime
